// The "Method & sources" screen (src/info/meals/method-screen.ts): every
// formula worked through with the reader's own numbers. The reader here is the
// prototype's example user.
// Run: scripts/t.sh tests/info/meals/method-screen.test.ts

import { expect, test } from "bun:test";
import { foodTableRows, linkSegments, methodSections } from "../../../src/info/meals/method-screen";
