...
// comes back with. Run: scripts/t.sh tests/info/meals/checks.test.ts

import { expect, test } from "bun:test";
import { checkPlan, fishMeals } from "../../../src/info/meals/checks";
import { targetsOf } from "../../../src/info/meals/solve-week";
import type { Meal, WeekPlan } from "../../../src/info/meals/types";
import { MEAL_KEYS } from "../../../src/info/meals/types";
