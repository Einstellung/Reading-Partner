// The shopping list's drawing order (src/info/meals/screen/list-order.ts): settled on
...
import {
  ...
  shoppingPreview,
  shoppingStatus,
} from "../../../../src/info/meals/screen/list-order";
import {
  addReaderItem,
  deriveShoppingList,
  markShoppingDone,
  setShoppingChecked,
  shoppingItemKey,
} from "../../../../src/info/meals/plan/shopping";
