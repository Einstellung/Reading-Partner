// Which picture each ingredient gets (src/info/meals/photos/images.ts), and how it is
// loaded: an external one only through the img: proxy (docs/pitfall/30), an
// app-relative one straight. Run: bash scripts/t.sh tests/info/meals/photos/images.test.ts
...
import {
  ...
  MEALDB_ALIASES,
  stripSources,
} from "../../../../src/info/meals/photos/images";
import { MEALDB_INGREDIENTS } from "../../../../src/info/meals/photos/mealdb-ingredients";
