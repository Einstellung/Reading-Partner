// The streaming reply's tool-call trace (src/components/common/toolTrace), shared
// by the reading companion and the info companion. Pure. Run: bun test.

import { expect, test } from "bun:test";
import { appendRunningTool, resolveToolStatus } from "../../src/components/common/toolTrace";
