...
> 上游是 [15](../companion/15-语音输入.md)（桌面那条送硅基流动）和 [27](../companion/27-实时语音.md)（「Linux 桌面和 Android 的 ASR 换件」一直没定）。iOS 已经在设备上听写（[33](../info/33-语音简报.md)），本文不动它。调研日期 2026-09-12，只查了资料，没在本机跑过。
