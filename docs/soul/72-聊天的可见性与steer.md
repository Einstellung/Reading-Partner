...
> 2026-09-18 定案。上游：[55](./55-legion.md) 是 run 与 progress，[68](../companion/68-Lumen与盒子的交互.md) 是回原地与盒，[71](./71-soul.md) 是 soul，[03](../reading/03-陪读交互-通话模型.md) 是 turn 属于线程，[21](../info/21-info收藏与reading打通.md) 是可见性是闸的一部分。
>
