...
2026-08-27 在 Linux 桌面机上量的 TTS 选型数据，四轮。结论吸收进 [33](../../info/33-语音简报.md) 的「实测」（延迟、音质、读音）和「小米落地要点」，候选状态在 [TTS供应商横评](../../research/TTS供应商横评.md)，句首静音抖动那条在坑 188。实测发现结论不对时回来查这里。
