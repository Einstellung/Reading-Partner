...
// Delete a talk. The conversation file and the deck under slides/<talkId>/ are
// left where they are: the thread store owns one and the slides pipeline the
// other, and an orphan of either is inert.
