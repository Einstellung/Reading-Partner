...
// The shared companion tool set bound live: the source tools, read_page and
// generate_briefing. The card sink surfaces the trial confirm card, and the
// briefing controller drives the regenerate tool. statement_write is not among
// them — the soul mounts it on every turn (docs/pitfall/324).
//
