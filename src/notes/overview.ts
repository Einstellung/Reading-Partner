...
// instruction, so the prompt carries exactly one language directive: "auto"
// keeps the English default, a set language replaces it.
export function overviewSystemPrompt(aiLanguage: AiLanguage = "auto"): string {
  ...
  return [
    ...
    "the whole.",
    "",
    `Write in ${lang} as markdown, 200-500 words. Cover the book's core thesis and`,
