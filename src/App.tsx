...
import CallBubble from "./ui/components/chat/call/CallBubble";
import CallView from "./ui/components/chat/call/CallView";
...
import ReadingPipCard from "./ui/components/chat/call/ReadingPipCard";
import ChatPipCard from "./ui/components/chat/call/ChatPipCard";
import SettingsDialog from "./ui/components/SettingsDialog";
import SettingsView from "./ui/components/SettingsView";
import { levelGate, toolInCall, type CallRow } from "./reading/turn/call-state";
import { asideReturnable } from "./reading/aside";
import { markExcerpt } from "./reading/turn/reopen";
...
export default function App() {
  ...
  // What a mark is a door into (docs/03, docs/09): the stroke that lands and the
  // conversation it starts, the press that reopens one, and the trace-list row
  // that goes to either the page or the room. Below the call because every one
  // of them needs its ways in.
  const {
  ...
  }, [readerSettings, settingsShowing, popup, endCall, currentCall, returnFromAside, quoteHlActive, sidebarOpen, sidebarColumn]);
