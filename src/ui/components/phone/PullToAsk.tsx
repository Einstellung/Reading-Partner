...
export function PullToAsk({
  ...
  return (
    ...
    <div ref={hostRef} className="absolute inset-0 overflow-hidden">
      ...
      >
        <span className="mb-3 flex items-center gap-1.5 whitespace-nowrap rounded-full border border-[#c9c2e8] bg-white px-3 py-1.5 text-[13px] text-[#4a3a9e] group-data-[armed=true]:border-[#6d5ae0] group-data-[armed=true]:bg-[#6d5ae0] group-data-[armed=true]:text-white">
          <IconSparkle size={14} />
