  ...
  return (
    <div className="absolute inset-0 overflow-y-auto bg-background">
      <div className="mx-auto flex w-full max-w-lg flex-col px-4 py-5">
        <div className="sticky top-0 z-10 -mx-4 mb-4 flex items-center gap-3 border-b border-[#ececec] bg-background/85 px-4 py-3 backdrop-blur">
        ...
        <ul className="m-0 flex list-none flex-col gap-2 p-0">
          {articles.map((a) => {
            ...
            return (
              <li key={a.id}>
                <button
                  className="flex w-full flex-col items-start gap-1.5 rounded-xl border border-[#e6e6e6] bg-card p-4 text-left coarse:min-h-[44px] hover:border-[#d3ccef]"
                  onClick={() => onOpen(a)}
                >
