...
export function AsideReceiptCard({ payload, dispatch }: CardComponentProps<AsideReceiptCardData>) {
  return (
    <button
      ...
      className="flex w-full max-w-md items-center gap-2 rounded-xl border border-black/10 bg-white/60 px-3 py-2 text-left can-hover:hover:bg-white coarse:py-3"
    >
