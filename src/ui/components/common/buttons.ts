...
// border-transparent, not border-0: BTN sits on a 1px border, so the primary
// needs one too or it renders 2px shorter next to it.
export const BTN_PRIMARY =
  "inline-flex items-center justify-center text-sm leading-none px-3 py-1.5 rounded-md border border-transparent bg-[#6c4fd0] text-white cursor-pointer enabled:hover:bg-[#5a3fbf] disabled:opacity-40 disabled:cursor-default coarse:min-h-[44px]";
