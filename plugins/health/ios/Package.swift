...
// The floor is the app's, not this plugin's: the HealthKit calls used here are
// far older, but docs/33 raised the whole app's minimum system version to 26 and
