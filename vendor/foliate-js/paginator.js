...
class View {
    ...
    constructor({ container, onExpand }) {
        ...
        // PATCHED: upstream value is 'allow-same-origin allow-scripts'. A book
        // may carry inline script, and same-origin + allow-scripts runs it with
        // the app's own privileges. Dropped to 'allow-same-origin'; the global
        // is there so the WebKit bug above can be measured either way (docs/62).
        this.#iframe.setAttribute('sandbox',
            globalThis.__foliateSandbox ?? 'allow-same-origin')
